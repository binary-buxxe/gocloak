...
Forked from https://github.com/Nerzal/gocloak

## Changelog

- Added support for jwt.TokenOptions
...
```shell
go get github.com/binary-buxxe/gocloak/v13
```

### Importing

```go
 import "github.com/binary-buxxe/gocloak/v13"
```
